...
export default  {
	...
	personal: {
		...
		invitation:{
			title:"邀请好友，分享利润赚不停",
			t2:'当您通过此活动页面成功邀请新用户注册使用YaPay钱包后，新用户每次完成交易或消费操作后，您均可获得对应的分享利润：',
			lj:'累计利润',
			zf:'支付利润',
			jy:'交易利润',
			yyq:'已邀请：{}人',
			...
			qy1:'权益一',
			qy2:'权益二',
			yqrf:'邀请人可获得被邀请人「法币交易」成交额的利润',
			yqrs:'邀请人数',
			yj:'一级利润(成交额)',
			ej:'二级利润(成交额)',
			jrys:"{}人以上",
			yqfz:'邀请人可获得被邀请人消费成交额（支付）的利润',
			il:['邀请人的利润不设上线，多邀多得;','佣金结算时间：迪拜时间每日凌晨24:00;','yapay团队保留此活动的最终解释权;']
		},
		//修改登录密码
		editLPwd:{
			title:'修改登录密码',
		...
		editJPwd:{
			...
			rtsx:'为了您的资产安全，您需要通过验证后才能重置交易密码，您当前设置的验证方式为邮箱验证，我们会将邮箱验证码发送到{}这个邮箱，请注意查收。'
